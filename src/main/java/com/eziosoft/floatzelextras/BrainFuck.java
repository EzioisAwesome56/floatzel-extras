...
public class BrainFuck {
    ...
    public static String ParseBrainFuck(String fuck) throws NullPointerException {
        ...
        while (count != len){
            instructions++;
            if (instructions > 500){
                throw new NullPointerException("brainfuck program contains too many instructions!");
            }
            ...
            if (instruct.equals(">")){
                ...
                if (mem[cell] == 0){
                    ...
                    while (!fuck.substring(count, count + 1).equals("]")){
                        ...
                        instructions++;
                        if (temp > 100){
                            throw new NullPointerException("Brainfuck loop is too long!");
                        }
                        count++;
                    }
                }
